...
public class User {
    ...
    @Nullable
    String email;
    //TODO: Que hago con el password? Lo guardo o no?
    @VisibleForTesting
    @Nullable
    String password;
    @Nullable
    ...
    public User(String uid, String username, String email, String provider, String photo_url, String name/*, String password*/) {
        this.uid = uid;
